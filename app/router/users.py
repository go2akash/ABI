...
from app.schemas.users import UserCreate, UserResponse, UserLogin, UserUpdateForm, UserUpdateResponse, UserWithAccountResponse
from app.db.base import get_db
from app.auth.users import get_current_user, get_password_hash, authenticate_user, ACCESS_TOKEN_EXPIRE_MINUTES,create_user_token
...
def current_users_details(db:Annotated[Session,Depends(get_db)],users:Annotated[User,Depends(get_current_user)]):
